...
public class SmartMultiPurposeSelector {
	...
	public SmartMultiPurposeSelector(Context context) {
	...
	public SmartMultiPurposeSelector setPressedDrawableResource(int pressedDrawableResource) {
	...
	public SmartMultiPurposeSelector setDefaultDrawableResource(int defaultDrawableResource) {
	...
	public SmartMultiPurposeSelector setPressedBgColor(int pressedBgColor) {
	...
	public SmartMultiPurposeSelector setDefaultBgColor(int defaultBgColor) {
	...
	public SmartMultiPurposeSelector setPressedTextColor(int pressedTextColor) {
	...
	public SmartMultiPurposeSelector setDefaultTextColor(int defaultTextColor) {
