...
public class SmartHorizontalAutoScroller extends HorizontalScrollView {
	...
	public SmartHorizontalAutoScroller(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public SmartHorizontalAutoScroller(Context context) {
		super(context);
		init();
	}
