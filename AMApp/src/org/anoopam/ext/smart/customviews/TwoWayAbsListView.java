...
ViewTreeObserver.OnTouchModeChangeListener {
	...
	/**
	 * The last scroll state reported to clients through {@link TwoWayAbsListView.OnScrollListener}.
	 */
...
//	//}
	...
	void updateScrollIndicators() {
		if (mScrollUp != null && mScrollVertically) {
			...
			mScrollUp.setVisibility(canScrollUp ? VISIBLE : INVISIBLE);
		}
		...
		if (mScrollDown != null && mScrollVertically) {
			...
			mScrollDown.setVisibility(canScrollDown ? VISIBLE : INVISIBLE);
		}
		...
		if (mScrollLeft != null && !mScrollVertically) {
			...
			mScrollLeft.setVisibility(canScrollLeft ? VISIBLE : INVISIBLE);
		}
		...
		if (mScrollRight != null && !mScrollVertically) {
			...
			mScrollRight.setVisibility(canScrollRight ? VISIBLE : INVISIBLE);
		}
	}
