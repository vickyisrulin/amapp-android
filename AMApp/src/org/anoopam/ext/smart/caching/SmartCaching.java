package org.anoopam.ext.smart.caching;
...
import org.anoopam.ext.smart.framework.SmartDataHelper;
...
//                    populateSchemaAndValues(mapTableNameAndData,tableData, jsonObject.getJSONObject(key), primaryColumnNames, columnNames,null, shouldDeleteOldRecords, shouldParseOnly, false, unNormalizedFields);
    ...
    private void categorizeParentContentValues(JSONObject jsonObject, ArrayList<String> originalParentColumnNames, ArrayList<String> primaryColumnNames, ContentValues primaryContentValues) {
        ...
        /*for (String columnName : primaryColumnNames) {
            try {
                ...
                primaryContentValues.put(columnName, jsonObject.getString(columnName));
            } catch (JSONException e) {
                e.printStackTrace();
            }
        }*/
    ...
    public boolean createTable(String tableName, ArrayList<String> primaryColumnNames, ArrayList<String> columnNames, boolean shouldDeleteOldRecords) {
