 ...
 */
public class NetworkCircularImageView extends CircleImageView {
	...
	public NetworkCircularImageView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public NetworkCircularImageView(Context context, AttributeSet attrs, int defStyle) {
