...
public class AMConstants {
    ...
    // AMS Service Contstants
    public static final String AMS_Domain_Url = "http://anoopam.org";
    public static final String AMS_ThakorjiToday_Endpoint = "/api/thakorji.php";
    public static final String AMS_QuoteOfTheWeek_Endpoint = "/v2/5665890a250000602c996e79";
